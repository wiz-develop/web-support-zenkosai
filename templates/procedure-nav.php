<div class="page-content-innerwrap procedure_list">
    <?php if(!is_page('procedure')) : ?>
    <h3>他の各種手続き</h3>
    <?php endif; ?>
    <div class="page-content-div">
        <div class="about-nav">
            <div class="about-nav-list container">
                <?php
                    // 指定したIDの子ページ一覧を表示
                    $about_page_data = get_page_by_path('procedure');
                    ...
                    foreach ( $children_array as $child ) {
                        ...
                        $html .= '</div>';
                        $html .= '</a>';
                        $html .= '<p class="mb-0">'.strip_tags(CFS()->get('procedure_subtext', $child->ID)).'<p>';
                        $html .= '</li>';
                        echo $html;
                    };
                '</ul>';
