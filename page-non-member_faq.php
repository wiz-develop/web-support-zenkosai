    ...
    <div class="page-content-wrapper columns">
        <div class="container">
            <?php if (is_page('non-member_faq')): ?>
                ...
                <div class="page-content-innerwrap">
                    <div class="page-content-div mb-5">
                        <p class="mb-0 text-center">FAQコーナー「おしえてライノくん」よりご覧ください。</p>
                    </div>
                </div>
                <div class="page-content-div">
                    <div class="page-link_btn">
                        <a href="/faq/" class="row justify-content-center">
                            <div class="col-12 col-md-4 col-lg-3">
                                <!-- <button class="btn border shadow-sm px-4 mt-3 mb-4 rounded-pill" style="background-color: #bbab72; color: white;">
                                    おしえてライノくん
                                </button> -->
                                <img class="w-100" src="/cms/wp-content/themes/zenkosai/assets/images/common/faq_raino.png">
                            </div>
                        </a>
                    </div>
                </div>
                <?php endif; ?>
            <?php endif; ?>
            <?php if (is_page('non-member_faq-2')): ?>
                <?php if (is_user_loggedin()) : ?>
                <div class="page-content-innerwrap">
                    <div class="page-content-div mb-5">
                        <?php the_content();?>
